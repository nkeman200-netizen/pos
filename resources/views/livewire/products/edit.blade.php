<div class="p-6 lg:p-8 bg-gray-50 dark:bg-slate-900 min-h-screen transition-colors duration-300">
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Edit Master Obat</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Form input profil dasar obat baru di apotek</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-3xl mx-auto bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 overflow-hidden">
        ...
        <form wire:submit="update" class="p-6 sm:p-8 space-y-6">
