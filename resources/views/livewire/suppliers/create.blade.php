<div class="p-6 lg:p-8 bg-gray-50 dark:bg-slate-900 min-h-screen transition-colors duration-300">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-black text-gray-800 dark:text-gray-100 tracking-tight">Tambah Supplier</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Pendaftaran data PBF atau distributor baru</p>
            </div>
        </div>

        <form wire:submit="save" class="bg-white dark:bg-slate-800 p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 space-y-6 transition-colors">
            <div>
